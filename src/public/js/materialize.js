		...
		return function (c, d, b, f) {
			if (0 <= c && 1 >= c && 0 <= b && 1 >= b) {
				...
				return function (k) {
					...
					let n = 3 * (1 - 3 * b + 3 * c) * l * l + 2 * (3 * b - 6 * c) * l + 3 * c;
					if (0.001 <= n) {
						for (h = 0; 4 > h; ++h) {
